    ...
    public void saveClient() {
        ...
        if (this.selectedClient.getId() == null) {
            ...
            try (Connection con = dataSource.getConnection()) {
                ...
                ps.setString(3, this.selectedClient.getDate());
            ...
            try (Connection con = dataSource.getConnection()) {
                ...
                String updateQuery = "UPDATE data.listclients set lcl_name=?,lcl_last_name=?,lcl_pasport=?,lcl_local=? WHERE lcl_id=?";
            ...
            try (Connection con = dataSource.getConnection()) {
                ...
                String updateQuery = "UPDATE data.historyclients set cl_numbercontract=?,cl_create_date=?,cl_days=? WHERE cl_lcl_id=?";
                PreparedStatement ps = con.prepareStatement(updateQuery);
                ps.setInt(1, this.selectedClient.getNumberContract());
                ps.setString(2, this.selectedClient.getDate());
